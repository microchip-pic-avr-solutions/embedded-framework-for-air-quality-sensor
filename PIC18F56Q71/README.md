...
- Depending on which sensors in the framework are connected in the MikroE slot, you will have to include the header file <br>
![main1](../images/main1.png)
- Next step is to call the sensor struct as shown below
- You will have to call the constructor function to use generic APIs
- Now the generic APIs can be used, such as AQSensor_init,  AQSensor_get_id, AQSensor_get_tvoc, and AQSensor_get_co2 <br>
![main2](../images/main2.png)

## Running the Example project

- Open the PIC18F56Q71.X project in MPLAB X IDE<br>
![examplepic1](../images/examplepic1.png)
- Click on Make and program device Main Project<br>
![examplepic2](../images/examplepic2.png)
- The status of the programming should be shown in the output window<br>
![examplepic3](../images/examplepic3.png)
